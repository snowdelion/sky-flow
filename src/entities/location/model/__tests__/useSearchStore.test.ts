...
describe("useSearchStore", () => {
  ...
  it("should save last validated city", () => {
    expect(useSearchStore.getState().lastValidatedCity).toEqual(DEFAULT_CITY_DATA)
  ...
  it("should partialize save units to localStorage", () => {
    ...
    const storage = JSON.parse(window.localStorage.getItem(STORAGE_KEYS.SEARCH) as string)
