import { generateTicks, getAspect, getTicks, getXTickFormatter } from "./chart.utils"
...
describe("chart-utils", () => {
  describe("generateTicks", () => {
    ...
    ])("should return 1, 2 or 5 step depending on diff", ({ min, max, expected }) => {
  ...
  describe("getTicks", () => {
    ...
    ])("should get chart ticks and handle missing data", ({ data, expected }) => {
  ...
  describe("getAspect", () => {
    ...
    ])("should return expected for every device type", ({ isM, isT, expected }) => {
  ...
  describe("getXTickFormatter", () => {
    ...
    ])("should return expected for 12/24 hour format", ({ value, data, expected }) => {
