...
describe("SearchDropdown", () => {
  ...
  const dropdownRef = createRef<HTMLDivElement> as unknown as React.RefObject<HTMLDivElement | null>
  ...
  it("should renderWithClient SearchTabs when inputValue is empty", () => {
    ...
    renderWithClient(<SearchDropdown inputRef={inputRef} dropdownRef={dropdownRef} />)
